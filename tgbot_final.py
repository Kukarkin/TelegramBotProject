...
Example: /stock_prediction AMZN ARMA
...
/stock_overview Provides the performace statistics of a company
Example: /stock_overview AMZN

/abbreviation_list A list of useful abbreviations used for fundamental analysis

/help A list of all useful commands
''')
...
def main():
	print('bot pashet')
	TOKEN = os.getenv("1603904670:AAEr5cAi1K0y2KbJng7W3BaJHLZ8j-Zgvg4")
	updater = Updater("1603904670:AAEr5cAi1K0y2KbJng7W3BaJHLZ8j-Zgvg4", use_context=True)
	...
	buttons_handler = CommandHandler('stock_prediction', data_type)
